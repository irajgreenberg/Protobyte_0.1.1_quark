...
ProtoCube::ProtoCube(const Vec3f& pos, const Vec3f& rot, const ProtoDimension3f size,
...
void ProtoCube::calcVerts() {
    
    }

void ProtoCube::calcInds() {
    l;
}
