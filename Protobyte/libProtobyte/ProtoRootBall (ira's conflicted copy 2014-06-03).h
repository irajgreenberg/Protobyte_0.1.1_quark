...
namespace ijg {
	...
	public:
		...
		void setTransformFunction(const ProtoTransformFunction& tranform);
		const ProtoTransformFunction& getTransformFunction() const;
	...
	inline void ProtoRootBall::setTransformFunction(const ProtoTransformFunction& tranform){
		this->transform = transform;
		trace(transform.getScalerRange());
		update(); // recalculate roots
	}

	inline const ProtoTransformFunction& ProtoRootBall::getTransformFunction() const{
		return transform;
	}
