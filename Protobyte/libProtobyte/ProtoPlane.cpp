...
void ProtoPlane::calcVerts() {
	...
	verts.push_back(ProtoVertex3(Vec3f(-.5f, -.5f, 0), col4, Tup2f(0, 1.0f / textureScale))); // LF
	verts.push_back(ProtoVertex3(Vec3f(.5f, -.5f, 0), col4, Tup2f(1.0f / textureScale, 1.0f / textureScale))); // RF
	verts.push_back(ProtoVertex3(Vec3f(.5f, .5f, 0), col4, Tup2f(1.0f / textureScale, 0))); // RB
